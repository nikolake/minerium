...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so MineriumUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(MineriumUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(MineriumUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(MineriumUnits::formatWithUnit(nDisplayUnit, amount, true, MineriumUnits::separatorAlways));
