...
#ifndef MINERIUM_QT_MINERIUMUNITS_H
#define MINERIUM_QT_MINERIUMUNITS_H
...
/** Minerium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MineriumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MineriumUnits(QObject *parent);

    /** Minerium units.
      @note Source: https://en.minerium.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MINR,
...
typedef MineriumUnits::Unit MineriumUnit;

#endif // MINERIUM_QT_MINERIUMUNITS_H
