    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MINR-light"), QVariant("light"));
    ui->theme->addItem(QString("MINR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MINR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MINR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MINR-traditional"), QVariant("trad"));
    
    /* Language selector */
    QDir translations(":translations");

    ui->mineriumAtStartup->setToolTip(ui->mineriumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->mineriumAtStartup->setText(ui->mineriumAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MineriumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mineriumAtStartup, OptionsModel::StartAtStartup);
