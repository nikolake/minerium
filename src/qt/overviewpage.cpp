...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(), unit(MineriumUnits::MINR),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = MineriumUnits::floorWithUnit(unit, amount, true, MineriumUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, MineriumUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, MineriumUnits::separatorAlways));
    ui->labelImmature->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, MineriumUnits::separatorAlways));
    ui->labelAnonymized->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, MineriumUnits::separatorAlways));
    ui->labelTotal->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, MineriumUnits::separatorAlways));
    ui->labelWatchAvailable->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, MineriumUnits::separatorAlways));
    ui->labelWatchPending->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, MineriumUnits::separatorAlways));
    ui->labelWatchImmature->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, MineriumUnits::separatorAlways));
    ui->labelWatchTotal->setText(MineriumUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, MineriumUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("MINR")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = MineriumUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, MineriumUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), MineriumUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = MineriumUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, MineriumUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), MineriumUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(MineriumUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(MineriumUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
