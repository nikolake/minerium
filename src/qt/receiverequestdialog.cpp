...
#include "config/minerium-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMineriumURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MineriumUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMineriumURI(info));
}
