...
#ifndef MINERIUM_VALIDATIONINTERFACE_H
#define MINERIUM_VALIDATIONINTERFACE_H
...
protected:
	...
	virtual void NotifyMineriumUpdate(const char *value, const char *topic) {}
...
struct CMainSignals {
	...
	/** Notifies listeners of an updated minerium payload with a topic. */
	boost::signals2::signal<void(const char *value, const char *topic)> NotifyMineriumUpdate;
...
#endif // MINERIUM_VALIDATIONINTERFACE_H
