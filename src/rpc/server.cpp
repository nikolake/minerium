...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Minerium Core server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Minerium Core server stopping";
}
...
{ //  category              name                      actor (function)         okSafe argNames
  ...
  // MINERIUM rpc functions
	...
	{ "wallet", "mineriumsendrawtransaction",		 &mineriumsendrawtransaction,	false ,  {}},
	{ "wallet", "mineriumdecoderawtransaction",		 &mineriumdecoderawtransaction,	false ,  {}},
	{ "wallet", "mineriumlistreceivedbyaddress",		 &mineriumlistreceivedbyaddress,	false ,  {}},
	{ "wallet", "prunemineriumservices",          &prunemineriumservices,          false ,  {}},
...
{
    return "> minerium-cli " + methodname + " " + args + "\n";
}
