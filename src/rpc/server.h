...
#ifndef MINERIUM_RPCSERVER_H
#define MINERIUM_RPCSERVER_H
...
/**
 * Minerium RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue prunemineriumservices(const JSONRPCRequest& request);
...
extern UniValue mineriumlistreceivedbyaddress(const JSONRPCRequest& request);
extern UniValue sendrawtransaction(const JSONRPCRequest& request);
extern UniValue createrawtransaction(const JSONRPCRequest& request);
extern UniValue mineriumsendrawtransaction(const JSONRPCRequest& request);
extern UniValue mineriumdecoderawtransaction(const JSONRPCRequest& request);
