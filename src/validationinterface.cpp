...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifyMineriumUpdate.connect(boost::bind(&CValidationInterface::NotifyMineriumUpdate, pwalletIn, _1, _2));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifyMineriumUpdate.disconnect(boost::bind(&CValidationInterface::NotifyMineriumUpdate, pwalletIn, _1, _2));
...
void UnregisterAllValidationInterfaces() {
	...
	g_signals.NotifyMineriumUpdate.disconnect_all_slots();
