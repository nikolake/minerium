...
#define BOOST_TEST_MODULE Minerium Test Suite

#include "test_minerium.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_minerium_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
