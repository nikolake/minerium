...
#ifndef MINERIUM_TEST_SCRIPTNUM10_H
#define MINERIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Minerium Core 0.10.0, for cross-comparison.
 */
public:
