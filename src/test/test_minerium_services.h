...
#ifndef MINERIUM_TEST_TEST_MINERIUM_SERVICES_H
#define MINERIUM_TEST_TEST_MINERIUM_SERVICES_H
...
/** Testing minerium services setup that configures a complete environment with 3 nodes.
 */
...
const string OfferNew(const string& node, const string& aliasname, const string& category, const string& title, const string& qty, const string& price, const string& description, const string& currency, const string& certguid="''", const string& paymentoptions="MINR",  const string& offerType = "BUYNOW", const string& auction_expires = "0", const string& auction_reserve = "0", const string& auction_require_witness = "false", const string &auction_deposit = "0", const string& witness="''");
...
struct MineriumTestingSetup {
    MineriumTestingSetup();
    ~MineriumTestingSetup();
};
struct BasicMineriumTestingSetup {
    BasicMineriumTestingSetup();
    ~BasicMineriumTestingSetup();
};
struct MineriumMainNetSetup {
	MineriumMainNetSetup();
	~MineriumMainNetSetup();
};
#endif
