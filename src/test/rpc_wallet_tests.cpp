...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	UniValue r;
	CPubKey demoPubkey;
	CMineriumAddress demoAddress;
	UniValue retValue;
	string strAccount = "walletDemoAccount";
	CMineriumAddress setaccountDemoAddress;
	{
		LOCK(pwalletMain->cs_wallet);

		demoPubkey = pwalletMain->GenerateNewKey(0, false);
		demoAddress = CMineriumAddress(CTxDestination(demoPubkey.GetID()));
		...
		setaccountDemoAddress = CMineriumAddress(CTxDestination(setaccountDemoPubkey.GetID()));
	}
	/*********************************
	* 			setaccount
	*********************************/
	...
	*********************************/
	...
	BOOST_CHECK(CMineriumAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	*********************************/
	...
	BOOST_CHECK(CMineriumAddress(arr[0].get_str()).Get() == demoAddress.Get());
