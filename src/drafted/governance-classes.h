 ...
 *
 *   // network
 *   CMineriumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.minerium.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMineriumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMineriumNetwork(UniValue objIn)
    {
...
// // can be under: MineriumNetwork
// //   -- signature requirements : Key1(User)
// class CMineriumNetworkVariable : public CGovernanceObject
// {
// private:
