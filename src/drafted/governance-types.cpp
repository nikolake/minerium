...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MineriumNetwork") type = MineriumNetwork;
    if(strType == "MineriumNetworkVariable") type = MineriumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MineriumNetwork) s = "MineriumNetwork";
    if(type == MineriumNetworkVariable) s = "MineriumNetworkVariable";
