 ...
 */
#ifndef MINERIUM_UTIL_H
#define MINERIUM_UTIL_H
...
extern const char * const MINERIUM_CONF_FILENAME;
extern const char * const MINERIUM_PID_FILENAME;
...
{
    std::string s = strprintf("minerium-%s", name);
