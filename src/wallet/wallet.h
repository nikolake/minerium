...
#ifndef MINERIUM_WALLET_WALLET_H
#define MINERIUM_WALLET_WALLET_H
...
public:
     ...
     * on this minerium node, and set to 0 for transactions that were created
...
public:
     ...
     */
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true, const CCoinControl *coinControl = NULL, bool fIncludeZeroValue=false, AvailableCoinsType nCoinType=ALL_COINS, bool fUseInstantSend = false, bool fIncludeMineriumAliasBalances = false, bool fIncludeMineriumAliasOutputs = false) const;
    ...
    /// Get 18000MINR output and keys which can be used for the Masternode
...
#endif // MINERIUM_WALLET_WALLET_H
