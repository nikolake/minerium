...
#ifndef MINERIUM_POLICY_POLICY_H
#define MINERIUM_POLICY_POLICY_H
...
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 10000; // was 50000 in 0.12.0 and it is 0 in Minerium since 0.12
...
#endif // MINERIUM_POLICY_POLICY_H
