...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s minerium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  minerium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded minerium transaction") + "\n" +
              "  minerium-tx [options] -create [commands]   " + _("Create hex-encoded minerium transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CMineriumAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CMineriumAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded minerium transaction
