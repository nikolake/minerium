...
#ifndef MINERIUM_SCRIPT_SCRIPT_H
#define MINERIUM_SCRIPT_SCRIPT_H
...
enum opcodetype
{
	...
	// minerium extended reserved 
	OP_MINERIUM_ALIAS = 0x01,
	OP_MINERIUM_CERT = 0x02,
	OP_MINERIUM_ESCROW = 0x03,
	OP_MINERIUM_OFFER = 0x04,
	OP_MINERIUM_ASSET = 0x05,
	OP_MINERIUM_ASSET_ALLOCATION = 0x06,
    OP_FALSE = OP_0,
    OP_PUSHDATA1 = 0x4c,
    OP_PUSHDATA2 = 0x4d,
    OP_PUSHDATA4 = 0x4e,
...
public:
    ...
    /**
     * Pre-version-0.6, Minerium always counted CHECKMULTISIGs
...
#endif // MINERIUM_SCRIPT_SCRIPT_H
