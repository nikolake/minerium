...
// Copyright (c) 2009-2012 The Minerium Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Minerium/$1-%s The Minerium/' %s"
REGEX_CURRENT= re.compile("%s The Minerium" % year)
