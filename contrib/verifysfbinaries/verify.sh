...
###   This script attempts to download the signature file SHA256SUMS.asc from minerium.org
...
WORKINGDIR="/tmp/minerium"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://minerium.org/bin/"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Minerium Core binary release signing key installed?"
   fi
