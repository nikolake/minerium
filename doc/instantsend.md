...
This mechanism has been integrated into Bitcore-Node-Minerium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/minerium/insight-api-minerium#web-socket-api](https://github.com/minerium/insight-api-minerium#web-socket-api) 
* API: [https://github.com/minerium/insight-api-minerium#instantsend-transactions](https://github.com/minerium/insight-api-minerium#instantsend-transactions) 
