...
* minerium.conf: contains configuration settings for mineriumd or minerium-qt
* mineriumd.pid: stores the process id of mineriumd while running
...
* debug.log: contains debug information and general logging generated by mineriumd or minerium-qt
