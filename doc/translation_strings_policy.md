...
This document provides guidelines for internationalization of the Minerium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `minerium_en.ts` remains unchanged.
