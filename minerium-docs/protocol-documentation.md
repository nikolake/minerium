...
This document describes the protocol extensions for all additional functionality build into the Minerium protocol. This doesn't include any of the Minerium protocol, which has been left intact in the Minerium project. For more information about the core protocol, please see https://en.minerium.it/w/index.php?title#Protocol_documentation&action#edit
...
Minerium Outpoint https://minerium.org/en/glossary/outpoint
...
Minerium Input https://minerium.org/en/glossary/input
...
Minerium Output https://minerium.org/en/glossary/output
...
Minerium Public Key https://minerium.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 15000 MINR
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 15000 MINR unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 minerium)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the minerium treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 15000 MINR for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 15000 MINR for masternode 2
